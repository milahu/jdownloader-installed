...
(function() {
    ...
    var ha = /^(\/[a-zA-Z0-9_\-]+)+$/, ia = /^[a-zA-Z0-9\-_\.,!]+$/, ja = /^gapi\.loaded_[0-9]+$/, ka = /^[a-zA-Z0-9,._-]+$/, oa = function(a, b, c, d) {
        var e = a.split(";"), h = e.shift(), l = S[h], m = null;
        ...
        a = pa(a);
        ja.test(c) || U("invalid_callback");
        b = V(b);
        d = d && d.length ? V(d) : null;
        var e = function(a) {
            return f(a).replace(/%2C/g, ",")
        };
        return [f(a.e).replace(/%2C/g, 
            ",").replace(/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" + e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.a ? "/am=" + e(a.a) : "", a.b ? "/rs=" + e(a.b) : "", a.c ? "/zcms=" + e(a.c) : "", "/cb=", e(c)].join("")
    }, pa = function(a) {
        ...
        e = W(a, "rs");
        a = W(a, "zcms");
        return {e: b,version: c,a: d,b: e,c: a}
    }, V = function(a) {
